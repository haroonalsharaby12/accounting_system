<aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <img src="{{ asset('assets/admin/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
      style="opacity: .8">
   <span class="brand-text font-weight-light"> HAROON ALRASHEED POS</span>
   </a>
   <!-- Sidebar -->
   <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
         <div class="image">
            <img src="{{ asset('assets/admin/dist/img/h.jpg') }}" class="img-circle elevation-2" alt="User Image">
         </div>
         <div class="info">
